...
fn indice_player_encontra_a_nave_sem_varrer() {
    ...
    w.set_input(37, 1.0, 0.0, 0.0, 1.0, true, 0.0, None, None, false, None);
...
fn input_de_player_inexistente_e_ignorado() {
    ...
    w.set_input(999, 1.0, 0.0, 0.0, 1.0, true, 0.0, None, None, false, None);
...
fn colisao_por_grade_ainda_acerta_o_alvo() {
    ...
    w.set_input(1, 0.0, 0.0, 0.0, 0.0, true, 0.0, None, None, false, None);
